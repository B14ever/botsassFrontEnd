...
const ctxMap = new WeakMap<HTMLDivElement, ContextState>();
...
const WebThreads: React.FC<WebThreadsProps> = ({
  ...
  useEffect(() => {
    ...
    const setSize = () => {
      ...
      const w = Math.max(1, Math.floor(rect.width || container.clientWidth || (typeof window !== "undefined" ? window.innerWidth : 800)));
    ...
    // Listen directly on window & container for smooth interaction
